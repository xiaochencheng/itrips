...
<body>
<h2>Hello world!</h2>
<form action="/api/getUserList.html"
      method="post">
    <div>
    ...
    <div>
        ...
        <a href="${pageContext.request.contextPath}/WeCat/login?signature=12&timestamp=333&nonce=23&echostr=122">微信登陆</a>
        ...
        <a href="${pageContext.request.contextPath}/apiP/register.html">手机注册</a>
        <a href="${pageContext.request.contextPath}/api/register.html">邮箱注册</a>
