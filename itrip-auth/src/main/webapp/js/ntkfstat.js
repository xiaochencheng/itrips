...
var CON_RULE = {};
var CON_SERVER = {
    flashserver: 'http://hz-v100.ntalker.com/downt/t2d/',
    configserver: 'http://statics.ntalker.com/mcenter/'
};

/* @file nt1.js
 * @date 2018.08.30 18:40:34
 */
!function (window, underfined) {
    ...
    nTalk.fn = nTalk.prototype = {
        ...
        merge: function () {
            ...
            for (e = 1; e < i.length; e++) if (i[e] && null !== i[e]) if (void 0 === i[e].length) for (t in i[e]) i[e].hasOwnProperty(t) && (r[t] = i[e][t]); else for (t = 0, n = i[e].length; t < n; t++) void 0 !== r.length ? r.push(i[e][t]) : r[t] = i[e][t];
            return r
        },
        each: function (e, t, n) {
        ...
        access: function (e, t, n, r, i) {
            ...
            } else if (void 0 !== r) for (i = !0; o < a; o++) t(e[o], n, r);
            ...
            e && (e = "string" == typeof e ? [e] : e, t = t || emptyFunc, n = n || document.head || nTalk("head")[0] || document.documentElement, i = nTalk._getObjectNumber(e), 0 === a.length && 0 === i && t.apply(l, s), nTalk.each(e, function (e, c) {
                if (c) {
                    ...
                    a.push(c), d += c.indexOf("#rnd") > -1 ? String(h).substring(5, 11) : c.indexOf("#image") > -1 ? c.replace(/(.*?)\?(.*?)(#.*?)?$/gi, "-$2") : "", u = /\.((gif)|(png)|(jpg)|(bmp)|(jpeg))$/i.test(c) || /#image$/gi.test(c), isRobotImage = /#robotImg/gi.test(c), c = c.replace(/#rnd/i, f + "ts=" + h).replace(/#image/i, ""), o = (/^(https?:\/\/)/i.test(c) ? "" : nTalk.baseURI) + c, p && nTalk[p] ? (s.push(nTalk[p]), g()) : !p && loadList[d] ? (s.push(loadList[d]), g()) : u ? l = nTalk.preloadImage(o, function (e) {
                        ...
                        charset: "utf-8",
                        src: o
                    }).tag && p && (r["data-requiremodule"] = p), void 0 === (l = nTalk(r).appendTo(n)).get(0).onreadystatechange ? l.bind("load", T).bind("error", T) : l.bind("readystatechange", T).bind("error", T))
                }
            }))
        }, jsonp: function (e, t) {
        ...
        return toJSONString = function (e, t) {
            ...
            function walk(e, t) {
                var n, r = e[t];
                if (r && "object" == typeof r) for (var i in r) r.hasOwnProperty(i) && (void 0 !== (n = walk(r, i)) ? r[i] = n : delete r[i]);
        ...
        contains: function (e) {
            return void 0 !== this.hashTable[e]
        },
        clear: function () {
        ...
        bind: function (e, t) {
            ...
            return nTalk.each(this, function (e, t) {
                ...
                for (var r in t) if ("IFRAME" != t.tagName.toUpperCase()) try {
                    ...
                    nTalk.Log("remove(" + t.tagName + "):" + e.message, 3)
                }
                if (t.parentNode) try {
            ...
            if (arguments.length) return nTalk.each(this, function (n, r) {
                null === e && (e = ""), (t = nTalk.valHooks[r.type] || nTalk.valHooks[r.nodeName.toLowerCase()]) && "set" in t && void 0 !== t.set(this, e, "value") || (r.value = e)
            });
            if ((t = nTalk.valHooks[i.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(i, "value"))) return n;
            if ((t = nTalk.valHooks[i.type]) && "get" in t) {
                r = "radio" == this[0].type;
                for (var o = [], a = 0; a < this.length; a++) if (void 0 !== (n = t.get(this[a], "value")) && this[a].checked) {
                    if (r) return n;
                    o.push(n)
                }
                return r ? "" : o
    ...
    nTalk.doAjaxRequest = function (e) {
        var t = e.dataType || "text", n = e.success || emptyFunc, r = e.error || emptyFunc, i = xmlrequest();
        ...
        if (i.onreadystatechange = function () {
            ...
            if (void 0 === i.responseType) return r("", i, "Browser does not support setting response type"), null;
...
/* @file flashserver
 * @date 2018.10.12 00:06:11
 */
(function ($) {
    $.flashserver = {
        'trailserver': 'http://sh-trail.ntalker.com/trail/trail',
        'presenceserver': 'rtmp://him1.ntalker.com:8000/flashIM;rtmps://him1.ntalker.com:443/flashIM',
        'presencegoserver': 'http://hz-v100.ntalker.com/flashIM/wdkstatus',
        'crmcenter': '',
        'mcenter': 'http://hz-v100.ntalker.com/record/mcenters/',
        'coopserver': '',
        'roboturl': '',
        't2dstatus': 'http://hz-v100.ntalker.com/t2d2/t2dstatus',
        'chatview_in': '',
        'chatview_out': '',
        'chatview_wap': '',
        'queryurl': 'http://hz-v100.ntalker.com/spider/spider/',
        'tchatmqttserver': 'tcp://hz-v100.ntalker.com:3010/tchat2;ws://hz-v100.ntalker.com:3011/tchat2;wss://hz-v100.ntalker.com:3012/tchat2',
        'eduimmqttserver': '',
        'robotserver': 'http://hz-v100.ntalker.com/assist',
        'kpiserver': 'http://hz-v100.ntalker.com/kpi',
        'xpushim': 'ws://hz-v100.ntalker.com:3015/NEWIM;wss://hz-v100.ntalker.com:3016/NEWIM',
        'xpushthirdpush': 'http://hz-v100.ntalker.com/xpush/thirdpush',
        'isnoim': 2,
        'notrail': 0,
        'preload': 2000,
        'sessioncarry': '1',
        ...
        'xpushpolltimeout': '15',
        'usexpush': '0',
        'settingserver': 'http://hz-v100.ntalker.com/setting',
        'apiserver': 'http://hz-v100.ntalker.com/api/',
        'siteid': 'kf_9680'
    };
    ...
    t.animate ? t.Log("nt2.js loaded") : (t.animate = function () {
        ...
        if (n.toJSONString = function (e) {
            ...
            try {
                ...
                return t.Log("localStorage:" + e.message, 3), !1
            }
            if (e) {
                var i = "test";
                try {
                    ...
                    return t.Log("The browser localStorage is unavailable. " + e.message, 3), !1
                }
            }
            ...
            try {
                ...
                t.Log("store.remove:" + e.message, 3)
            }
        }, n.clear = function () {
            try {
                e.clear()
