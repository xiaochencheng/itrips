...
public class LoginController {
    ...
    @RequestMapping(value = "/userlinkAdd.html")
    public String userlinkAdd() {
        return "userlink/add";
    }

    @RequestMapping(value = "/userlinkModify.html")
    @ResponseBody
    public String userlinkModify(HttpServletRequest request , HttpServletResponse response) {
